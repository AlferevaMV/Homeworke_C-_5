...
int CountSize = Convert.ToInt32(Console.ReadLine());
...
// метод нахождения сумм чисел на нечетных позициях
...
Console.WriteLine($"\n\nSum of odd positions {MainMethod(CountSize)}\n");